...
def docs():
    ...
    <head>
        ...
        <style>
            body { font-family: 'Inter', sans-serif; max-width: 900px; margin: 0 auto; padding: 40px 20px; background: #1a1a2e; color: #fff; line-height: 1.6; }
            h1 { color: #6366f1; margin-bottom: 10px; }
            h2 { color: #a855f7; margin-top: 40px; margin-bottom: 20px; }
            h3 { color: #22c55e; margin-top: 30px; margin-bottom: 15px; }
            a { color: #6366f1; text-decoration: none; }
            a:hover { text-decoration: underline; }
            code { background: #16213e; padding: 2px 8px; border-radius: 4px; }
            pre { background: #16213e; padding: 20px; border-radius: 8px; overflow-x: auto; margin: 20px 0; }
            .nav { margin-bottom: 30px; }
            .nav a { margin-right: 20px; }
            .prereq-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin: 20px 0; }
            .prereq-item { background: #16213e; padding: 20px; border-radius: 8px; text-align: center; }
            .prereq-icon { font-size: 32px; margin-bottom: 10px; }
            .faq-item { background: #16213e; padding: 20px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #22c55e; }
            .faq-question { font-weight: 600; color: #22c55e; margin-bottom: 8px; }
            .faq-answer { color: #94a3b8; }
            .setup-link { display: inline-block; background: linear-gradient(90deg, #6366f1, #8b5cf6); color: white; padding: 15px 30px; border-radius: 8px; margin-top: 30px; font-weight: 600; }
            .setup-link:hover { transform: translateY(-2px); box-shadow: 0 10px 30px rgba(99, 102, 241, 0.4); }
    ...
    <body>
        ...
        <p style="color: #94a3b8;">Your Private AI Assistant for Email, Files & Data</p>
...
python3 main.py</pre>
        ...
        <p>The dashboard provides a visual interface for monitoring emails, files, and system health.</p>

        <h2>Configuration</h2>
        <p>Copy <code>.env.example</code> to <code>.env</code> and configure your settings:</p>
...
DEMO_MODE=false</pre>
        ...
        <div class="faq-item">
            <div class="faq-question">Does it work on Windows?</div>
            <div class="faq-answer">Yes! You can run GhostOffice natively with Python, or use Docker for a containerized setup. Docker is recommended for Windows users.</div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Which AI models work best?</div>
            <div class="faq-answer">We recommend <strong>phi3:mini</strong> for most users - it's fast, lightweight, and runs well on modest hardware. For more power, try <strong>llama3.2:3b</strong> or <strong>mistral</strong>.</div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Is my email password stored?</div>
            <div class="faq-answer">Never! Your password is used to create an AES-256 encryption key via PBKDF2 (600K iterations). The key is derived at runtime and never persisted. Only encrypted data is stored.</div>
        </div>
        
        <div class="faq-item">
            <div class="faq-question">Does it need internet?</div>
            <div class="faq-answer">No! GhostOffice is 100% offline. All AI processing happens locally via Ollama. Your emails are downloaded via IMAP but never sent anywhere else.</div>
        </div>
        ...
        <a href="/setup" class="setup-link">🚀 Go to Setup Wizard →</a>
        
        <hr>
        <p class="footer">GhostOffice v3.1 — Your Private AI Assistant</p>
    </body>
    </html>
    """
