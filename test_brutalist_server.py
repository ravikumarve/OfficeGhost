#!/usr/bin/env python3
"""
Test server to showcase the brutalist UI without authentication
"""
...
@app.route("/login")
def test_login():
    return "Login page would be here - but let's go straight to dashboard"


if __name__ == "__main__":
    print("🌐 Brutalist UI Test Server: http://127.0.0.1:5001")
    print("📁 Serving from:", app.template_folder)
